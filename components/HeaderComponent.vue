...
<template>
  <header class="fixed top-0 w-full py-5 z-10">
    <nav
    ...
    >
      <div class="flex items-center flex-1">
        ...
        <div class="hidden space-x-10 md:flex">
          <nuxt-link to="/" class="font-medium text-white hover:text-gray-300"
            >App</nuxt-link
          >
